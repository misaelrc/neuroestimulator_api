...
namespace NeuroEstimulator.Data.Migrations
{
    ...
    [Migration("20231119204420_update segment part")]
    partial class updatesegmentpart
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NeuroEstimulator.Domain.Entities.Account", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 19, 17, 44, 20, 367, DateTimeKind.Local).AddTicks(804));
            ...
            modelBuilder.Entity("NeuroEstimulator.Domain.Entities.AccountProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 17, 44, 20, 367, DateTimeKind.Local).AddTicks(5087));
            ...
            modelBuilder.Entity("NeuroEstimulator.Domain.Entities.Patient", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 17, 44, 20, 368, DateTimeKind.Local).AddTicks(2661));
            ...
            modelBuilder.Entity("NeuroEstimulator.Domain.Entities.Profile", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 17, 44, 20, 368, DateTimeKind.Local).AddTicks(7423));
            ...
            modelBuilder.Entity("NeuroEstimulator.Domain.Entities.Session", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 17, 44, 20, 369, DateTimeKind.Local).AddTicks(7697));
            ...
            modelBuilder.Entity("NeuroEstimulator.Domain.Entities.SessionParameters", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 17, 44, 20, 370, DateTimeKind.Local).AddTicks(3425));
            ...
            modelBuilder.Entity("NeuroEstimulator.Domain.Entities.SessionPhoto", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 17, 44, 20, 370, DateTimeKind.Local).AddTicks(7397));
            ...
            modelBuilder.Entity("NeuroEstimulator.Domain.Entities.SessionSegment", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 17, 44, 20, 373, DateTimeKind.Local).AddTicks(7999));
